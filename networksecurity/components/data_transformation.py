...
class DataTransformation:
    ...
    def get_data_transformation_object(cls)->Pipeline:
        """_summary_
        it initialises a knnimputer object with the parameters specified in the traning_pipeline.py  file 
        and returns a pipeline as a knnimputer object as the first step
        Args:
        data transformation
        Returns:
            Pipeline obj: _description_
        """
