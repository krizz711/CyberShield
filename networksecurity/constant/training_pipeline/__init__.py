...
"""
    data validation relatd constant start with DATA_VALIDATION VAR NAME
"""
...
# kkn imputer class to replace nan values
...
# s3 bucket name in aws should have same name as  TRAINING_BUCKET_NAME("networksecurity")
