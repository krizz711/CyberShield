...
class  DataValidationConfig:
    def __init__(self,traning_piepline_config:TrainingPipelineConfig):
        self.data_validation_dir: str =os.path.join(traning_piepline_config.artifact_dir, training_pipeline.DATA_VALIDATION_DIR_NAME)
